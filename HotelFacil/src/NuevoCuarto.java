...
public class NuevoCuarto extends Menu implements ActionListener
{
	...
	private static Double m_huespedes  = 0.00;
	private static Double m_habitacion = 0.00;
	private static Double m_total      = 0.00;
	...
	NuevoCuarto()
	{
		...
		enteros.get(1).addFocusListener(new FocusListener()
			{
				...
				public void focusLost(FocusEvent arg0)
				{
					...
					totalesm.get(0).setText(String.format("%16s",(String.valueOf(m_habitacion))));
					totalesm.get(2).setText(String.format("%16s",(String.valueOf(m_huespedes+m_habitacion))));
					totalesm.get(3).setText(String.format("%16s",(String.valueOf( 0.16 * (m_huespedes+m_habitacion) ))));
					m_total = 0.16 * (m_huespedes+m_habitacion) + m_huespedes+m_habitacion;
					totalesm.get(4).setText(String.format("%16s",(String.valueOf( m_total ))));
				}
				@Override
		...
		adelanto.addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				...
				Double m_adelanto = (Double) adelanto.getValue();
	...
	public static void nuevoHuesped(String e)
	{
		...
		m_huespedes  += costo;
		totalesm.get(1).setText(String.format("%16s",(String.valueOf(m_huespedes))));
		totalesm.get(2).setText(String.format("%16s",(String.valueOf(m_huespedes+m_habitacion))));
		totalesm.get(3).setText(String.format("%16s",(String.valueOf( 0.16 * (m_huespedes+m_habitacion) ))));
		m_total = 0.16 * (m_huespedes+m_habitacion) + m_huespedes+m_habitacion;
		totalesm.get(4).setText(String.format("%16s",(String.valueOf( m_total ))));
